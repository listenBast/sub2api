...
| `UPDATE_GITHUB_TOKEN` | No | *(empty)* | Token for private GitHub Release checks and API asset downloads; it is removed before redirects to object storage. |
...
1. Download the latest release from [GitHub Releases](https://github.com/listenBast/sub2api/releases)
