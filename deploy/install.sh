...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/listenBast/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="listenBast/sub2api"
...
Documentation=https://github.com/listenBast/sub2api
