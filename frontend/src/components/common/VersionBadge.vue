...
const GITHUB_REPO = 'listenBast/sub2api'
// GHCR image published by this fork's release workflow (tags omit the "v" prefix).
const DOCKER_IMAGE = 'ghcr.io/listenbast/sub2api'
