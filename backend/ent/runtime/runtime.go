...
func init() {
	...
	// apikeyDescBalanceMode is the schema descriptor for balance_mode field.
	apikeyDescBalanceMode := apikeyFields[8].Descriptor()
	// apikey.DefaultBalanceMode holds the default value on creation for the balance_mode field.
	apikey.DefaultBalanceMode = apikeyDescBalanceMode.Default.(string)
	// apikey.BalanceModeValidator is a validator for the "balance_mode" field. It is called by the builders before save.
	apikey.BalanceModeValidator = apikeyDescBalanceMode.Validators[0].(func(string) error)
	...
	// userDescTeamBalance is the schema descriptor for team_balance field.
	userDescTeamBalance := userFields[5].Descriptor()
	// user.DefaultTeamBalance holds the default value on creation for the team_balance field.
	user.DefaultTeamBalance = userDescTeamBalance.Default.(float64)
